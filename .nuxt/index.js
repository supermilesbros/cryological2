...
import nuxt_plugin_plugin_7e113b1b from 'nuxt_plugin_plugin_7e113b1b' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_12ff0026 from 'nuxt_plugin_bootstrapvue_12ff0026' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Vue.JS Technology & Blog Template","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"favicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_7e113b1b === 'function') {
    await nuxt_plugin_plugin_7e113b1b(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_12ff0026 === 'function') {
    await nuxt_plugin_bootstrapvue_12ff0026(app.context, inject)
  }
